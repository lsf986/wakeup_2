...
_FIELD_ALIASES = {
    ...
    "text_completeness": "text_completeness_score",
    "direct_address": "direct_address_score",
    "self_talk": "self_talk_score",
...
def frame_from_payload(payload: dict[str, Any]) -> MultimodalFrame:
    ...
    return MultimodalFrame(
        ...
        text_completeness_score=_as_float(normalized.get("text_completeness_score"), 1.0),
        direct_address_score=_as_float(normalized.get("direct_address_score"), 0.0),
        self_talk_score=_as_float(normalized.get("self_talk_score"), 0.0),
